...
var attrArray = ["petroleum", "gas", "coal", "iron", "manganese"];
var expressed = attrArray[0];

//name of each attribute to show on the map
var indicatorName = {};
indicatorName["petroleum"] = "petroleum";
indicatorName["gas"] = "gas";
indicatorName["coal"] = "coal";
indicatorName["iron"] = "iron";
indicatorName["manganese"] = "manganese";
...
function setLabel(props) {
	...
	var labelAttribute;
	if (!props[expressed]) {
		labelAttribute = "<h1>" + "No Data" + "</h1><b>" + "</b>";
	} else if (expressed == "petroleum") {
		labelAttribute = "<h1>" + Math.ceil(props[expressed]) + "0,000 tons" +
        "</h1><b>" + "</b>";
    }else if (expressed == "gas") {
		labelAttribute = "<h1>" + Math.ceil(props[expressed]) + "hundred million cubic meters" +
        "</h1><b>" + "</b>";
    }   else if (expressed == "coal") {
		labelAttribute = "<h1>" + Math.ceil(props[expressed]) + "hundred million tons" +
        "</h1><b>" + "</b>";
	}else if (expressed == "iron") {
		labelAttribute = "<h1>" + Math.ceil(props[expressed]) + "hundred million tons" +
        "</h1><b>" + "</b>";
...
function moveLabel() {
	var labelWidth = d3.select(".infolabel")
		...
		.width;
	//clientXY gives the coordinates relative to current window
